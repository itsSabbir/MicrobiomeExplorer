...
3. **Engineering Charter compliance** (~/.claude/CLAUDE.md § Engineering Charter — Non-Negotiable). Every change must satisfy all that apply:
   - Functions ≤ 60 LOC, ≤ 1 concern. Functions 60-80 LOC need a one-line comment justifying why splitting hurts clarity. > 80 LOC needs a refactor or commit-message waiver. The "single concern" test matters more than the LOC count.
